                    ...
                    <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 2 }}>
                      ...
                      <Typography 
                        ...
                        sx={{ 
                          flexGrow: 1, 
                          lineHeight: 1.3,
                          minHeight: '2.6em', // Ensure consistent height for titles
                          display: '-webkit-box',
                          WebkitLineClamp: 2,
                      ...
                      {university.description ? (
                        <Typography 
                          ...
                          sx={{ 
                            ...
                            WebkitBoxOrient: 'vertical',
                            overflow: 'hidden',
                            minHeight: '4.5em' // Consistent height for description area
                          }}
                        >
                          {university.description}
                        </Typography>
                      ) : (
                        <Box sx={{ minHeight: '4.5em' }} /> // Placeholder to maintain spacing
                      )}
                    </Box>
